...
\begin{abstract}
  ...
  prior to casting their ballots \mbox{affects} the cost of voting, which in
  principle should be uniformly distributed across voters.  Voting
  lines can lead to unequal treatment if some voters are compelled to
  wait in line longer than others.  In addition, long lines can
  condition future electoral participation.  We use voter check-in
  times from Florida---involving 942,166 early in-person voters from
  2012 and 1,687,217 from 2016---and highlight disproportionately
  problematic experiences faced by minority voters.  We find, however,
  fewer such problems in 2016 compared to 2012.  We estimate that
  Florida early in-person voters who waited excessively in 2012 had a
  very slightly lower probability---approximately one percent---of
  voting in 2016, \emph{ceteris paribus}.  Our results draw attention
  to the ongoing importance of the administrative features of
  elections that influence the cost of voting, and ultimately, whether
  voters in an election are treated equally.
\end{abstract}
...
unfairness and disparate treatment of particular groups of voters
\citep{norris2014electoral}.  An election can fail to treat all voters
equally if, for example, there are differences in vote tabulating
technologies across groups of voters
...
\citep[e.g.,][]{dyckgimpel:distance}.  Barriers to voting successfully
in an election contribute to the \emph{cost of voting}.
...
administration, are related to the principle of equal treatment of
voters.  The lines that develop outside a polling station reflect
administrative decisions about resource allocation as well as the
extent of voter turnout \citep{herronsmith:hanoverstudy}. 
If lines adversely affect some voters more than others, then
the principle of equal treatment is at risk.  Thus, if we want to know whether a given
election features equal treatment of voters, we must consider the
extent to which selected groups of voters who participate in it were
subjected to long lines, and through them, had a relatively high cost
of voting.
...
local laws.\footnote{For the composition of the 2012 and 2016
  ...
  respectively.} In-person voting experiences have a number of
...
Second, waiting in line is an experience that may have
``downstream,'' electoral effects, as characterized by
...
question, one without an imposing line, or even forego eating.\footnote{Alternatively, a line
...
which as we have already argued raises the cost of voting, might
decrease the likelihood of voting in the future.  Given the relatively
...
participatory consequences---are conceptually distinct. The time tax for voting
could be uniformly spread across voters, which might be normatively
pleasing in the sense of not violating the principle of equal
treatment of voters, and yet there could be a significant effect of
waiting in line on future electoral participation. Or, the time tax
could be concentrated on certain types of voters, which most would
argue violate equal treatment regardless of whether there are
...
around one percent. This is consistent with
\citet{pettigrew:longlinesminorityprecincts}.
...
observations about congestion at the polls and equal treatment.
...
Notwithstanding this, long lines at the polls continue to plague
voters across the country.  ``To me,'' Cynthia Perez complained in
...
increasingly popular; for analyses of early voting reforms and
...
The extent to which all the voters in an election are treated equally
...
increases to the extent that this distribution is not uniform, and
...
characterized by equal treatment or the lack thereof.
...
limited number of exceptions, nor are there official records on line
evolution and how long the voters waited.
...
who likely waited in line to vote.
...
coincides with survey results that pertain to voting lines.  In 2016,
...
and the extent to which voters are treating equally.
