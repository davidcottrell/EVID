...
lines that form in front of polling stations.  First, waiting in line to vote constitutes a time tax
...
concentrated on certain voter groups, which most would argue violate
equal treatment regardless of whether there are downstream
consequences of waiting to vote.

Notwithstanding post-election surveys of voters, which we discuss
later, little is known about the distribution of individual wait times
across voters.  This measurement problem, we would argue, is the major
impediment in voting line research.  To address this problem, we turn
...
not subject to self-reporting biases, and associated with each
check-in time is a voter's race/ethnicity, party registration, and
history of electoral participation.

% , pieces of
% information publicly available in Florida's statewide voter file.

In the interests of transparency at the outset, though, we emphasize
that the check-in times forming the basis of our research design do
not themselves specify voter wait times.  Rather, in what follows we
offer a set of assumptions under which check-ins can be used to study
...
namely, that survey respondents accurately remember, and when queried
report, their wait times.  All research designs incorporate
assumptions, and the literature on voting lines will be strengthened
to the extent that varied research designs invoke alternative sets of
assumptions.  This exemplifies triangulation.
...
three percentage points, and this is consistent with
