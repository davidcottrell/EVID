...
state or local laws. Voting in-person---as opposed to voting via
mail---requires traveling to a voting location, which is often called
a precinct, possibly waiting in a line, possibly authenticating
oneself with permitted forms of identification, physically registering
candidate and ballot measure preferences, and finally submitting a
ballot for tabulating. A voter's overall voting experience thus has a
number of facets, and our interest here is the second of the steps
noted above, namely, the act of waiting in line to before being
processed to vote.
...
lines in which voters already in the act of casting ballots have to
stand.  First, waiting in line to vote constitutes a time tax
\cite{mukherjee:timetax}.  This tax can be negligible---for example, a
voter waits a scant ten seconds prior to initiating her voting
process---or imposing---some of the Florida voters we describe shortly
waited over four hours to vote in 2012. Associated with a voting line
time tax is the type of distributional question that is associated
with all forms of taxation: is the voting time tax fair and, in
...
concrete, if a line in front a particular restaurant is long, some
individuals may substitute an alternative eatery for the restaurant in
question, one without a line.  On the other hand, a line in front of a
restaurant might be a quality signal, in which case the presence of a
line might be an incentive to eat at said restaurant.  Nonetheless,
while it is not \emph{a priori} clear that voting is substitutable in
the way that restaurent-visiting is, we should not dismiss outright
the possibility that the effect of waiting in line to vote, which
raises the cost to vote, might decrease the likelihood of voting in
the future.  Given the relatively low rate of voter participation in
American presidential elections, any aspect of voting experiences that
depresses turnout might be considered a matter of concern.

%% Need to add cite comparing American pres turnout with voting in
...
forthcoming analysis of early voting lines in Florida is divided into
...
is the lack of data on who waits to vote: among other things, it is
difficult to study the consequences of waiting in line to vote if one
cannot identify which voters waited to vote in the first place. Many
...
be accurate.  Reports of turnout in general may suffer from social
desirability bias.

%% Need to add cite: self-report turnout biases
...
participation history, all of which are part of a Florida voter's
...
formed in 2013 to address general election administrative issues, and
it devoted some of its January, 2014, report to lines: ``The
Commission has concluded that, as a general rule, no voter should have
to wait more than half an hour in order to have an opportunity to
vote'' \citep[p.\ 13][]{pcea:2014}.

With few exceptions, what we
know to date about congestion at the polls and ancillary wait times
for voters is derived from survey data. Most notably,
...
their experiences at the polls, including estimated wait times.
