...
%% Need to add cite comparing American pres turnout with voting in other industrial democracies  [DAS: added: International Institute for Democracy and Electoral Assistance http://www.idea.int/data-tools 
...
%% Need to add cite: self-report turnout biases [DAS: done]
...
The literature on voting lines in American elections is growing, focusing primarily on recent elections.  A Presidential Commission was
...
devoted some of its January, 2014, report to long lines. The report concluded that, ``[A]s a general rule, no voter should have to wait
more than half an hour in order to have an opportunity to vote'' \citep[p.\ 13,][]{pcea:2014}.\footnote{The executive order creating this 
...
times the national average \citep{stewart:waitingtovote2012}. In addition, surveys can help to identify when during the voting process wait times are most likely to occur. For example, in the 2012 General Election, \citeauthor{stewart:waitingtovote2012}'s SPAE found that over three-fifths of early in-person voters nationwide who reported waiting in line to vote said the wait was primarily during the check-in stage.
...
%% DAS: the following is Done; reworked these paragraphs so they flow better and bolster Why Florida
%% Need to add cite: how many vote in-person?
%% generic cite is Gronke 2012 -- the growth of EIP voting
%% at least 23 million EIP ballots cast in 2016, according to McDonald : http://www.electproject.org/early_2016
...
In 2016, more Florida voters---3.88 million---cast early in-person ballots than voters who mailed in their absentee ballots (2.76 million)
or who voted in person at their local Election Day precincts (2.96 million) \citep{FDOS:2016vote}. The prevalence of early in-person voting
...
mode of voting as given. Beyond Florida, there is good reason to focus on wait times during early in-person voting.  Michael P. McDonald,
on his Election Project website,
...
voting optical scan machine in a precinct was shut down. They find significant differences in the closing times of precincts within counties, contingent on a precicnt's racial and ethnic composition. 
In addition, Florida's open records laws provide a wealth of information not only about who votes, but when and how voters cast ballots.  Drawing on publicly available voter demographic and vote history data in Florida,   
\cite{amos_etal2017} find differences in individual-level turnout across political party and racial and ethnic categories among registered voters whose precincts were eliminated or relocated by local election administrators. 
Linking multiple statewide voter files and individual-level early voting files, \cite{herron_smith2014} demonstrate how reductions in the number of early voting days following the 2008 General Election 
led to a drop in early voting in 2012, especially among voters who had cast ballots on the final Sunday of early voting in 2008, which was eliminated by the state legislature. 
...
cove the 2012 and 2016 General Elections.  %%  David: footnote about
