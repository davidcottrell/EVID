...
Per Table \ref{tab:reg}, having voted in 2008 is positively associated
with voting in 2016, and being older is associated with greater
turnout.  Our age estimates in Table \ref{tab:reg} are presumably
underestimated; our model excludes the youngest voters in 2016, who
could not legally register to vote in Florida in 2008, and younger
registered voters are, \emph{ceteris paribus}, less likely to turnout
\citep{shinosmith:registrationtiming}.   Table \ref{tab:reg} also
shows that, \emph{ceteris paribus}, men vote less often than women and
that whites vote often than non-whites.

Our objective is not exploring the relationship between demographic
covariates and turnout.  Rather, we want to know about the marginal
effects of waiting in line, and to this end Figure
