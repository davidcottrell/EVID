...
contend with registration hurdles that others do not; if some voters
...
ballots \citep[e.g.,][]{dyckgimpel:distance}.  Barriers to voting
successfully in an election contribute to the \emph{cost of voting}.
...
voters.  If lines adversely affect some voters more than others, then
this principle is at risk.  Thus, if we want to know whether a given
election featured equal treatment of voters, we must consider the
extent to which selected groups of voters who participated in it were
