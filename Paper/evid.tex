...
consistent over time.  Floridians have for a decade consistently
reported having to endure some of the longest wait times in the
country. In the 2012 General Election, in-person voters in Florida
reported on average waiting 39 minutes to cast a ballot, three times
...
The use of survey results in the study of voter wait times relies on a
key assumption: self-reports of wait times experienced in a recent
...
accuracy can be negatively associated
\citep[e.g.,][]{hirstetal:sept11memories}, how an individual thinks
about a given task is related to the extent to which she thinks about
the passage of time \citep{conti:timeflies}, and one's enjoyment of a
task depends on feelings about time progression
\citep[e.g.,][]{sackettetal:timeflies}.  In short, it is far from
clear that scholars interested in wait times should be optimistic that
...
of voting lines impose assumptions on the problems they analyze.  The
research design we offer does not escape assumptions, and in this way
it is similar to survey-based designs.  However, as will be clear
shortly, the design implemented here imposes different assumption than
survey-based designs and most notably does not risk biases associated
...
only about who votes, but when and how voters cast ballots.
\cite{shinosmith:registrationtiming} demonstrate that voters who
