...
\begin{abstract}
  ...
  vote in 2016, \emph{ceteris paribus}.  Our results draw attention to
  the ongoing importance of the administrative features of elections
  that influence the cost of voting, and ultimately, whether voters in
  an election are treated equally.
\end{abstract}
...
sample.  Table \ref{tab:ate} reports estimates, along with 95\%
...
based on time of early vote in 2012.\footnote{We generated the results
  in Table \ref{tab:ate} with a simulation.  Our simulation (500
...
Table \ref{tab:ate} can be thought of as average treatment effects
