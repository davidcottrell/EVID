...
\begin{abstract}
  ...
  The presence of voting lines can lead to unequal treatment of voters
  if some voters are compelled to wait in line longer than others,
  thus causing the attendant cost of voting to vary systematically
  across an electorate.  In addition, long lines can influence future
...
evening lines, albeit not very long ones.\footnote{This discussion
  ...
  sensitive to waiting in line.  There is no employment data in the
  Florida statewide voter files, but a relationship between work
  opportunities and one's willingness to wait in line is worth
