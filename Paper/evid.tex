...
\begin{abstract}
  ...
  When the cost of voting varies by voter type, then voters are not
  being treated equally.  Voting lines can lead to unequal treatment
  if some voters are compelled to wait in line longer than others.  In
  addition, long lines can influence future electoral participation.
  We use voter check-in times from Florida---involving 942,166 early
  in-person voters from 2012 and 1,687,217 from 2016---and highlight
  disproportionately problematic experiences faced by minority voters.
  We find, however, fewer such problems in 2016 compared to 2012.
...
\emph{cost of voting} in a given election varies significantly across
groups of voters, the principle of equal treatment of voters is at
risk.
...
voters, we must consider the extent to which selected groups of voters
who participated in it were subjected to long lines.
...
concentrated on certain types of voters, which most would argue
violate equal treatment regardless of whether there are downstream
...
divided into two sections. First, with respect to the notion that
waiting in line constitutes a time tax, we assess which voters are
more likely to wait and whether all voters face equal waiting times
when checking in. Second, with respect to the downstream consequences
of waiting in line, we assess whether individuals who wait to vote are
less likely to vote in a subsequent election.
...
late in a day of early voting in 2012 were particularly less like to
vote early in 2016.
...
and conditional on voting in 2016}
  ...
  \centering
    \centering\includegraphics[scale = 0.8]{probability_of_voting_in_2016_over_under_early.pdf}
\end{figure}
