...
\begin{abstract}
  ...
  And when the cost of voting varies systematically by voter group,
  ...
  longer than others.  In addition, long lines can influence future
...
Long voting lines have received attention in the last several election
...
appear in Table \ref{tab:reg} in the appendix.\footnote{Our regression
  ...
  genders.}  %%% XXX Besides gender, need to say where we got
%%% this 709,956 number??
