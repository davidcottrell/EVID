...
\begin{abstract}
  ...
  1,687,217 from 2016---that highlight disproportionately long wait
  times incurred by minority voters.  We find, however, fewer problems
  in 2016 compared to 2012.  Florida early in-person voters who waited
...
voted in 2008.  Were we to plot probabilities for a different
demographic profile--e.g., a 30-year old Hispanic female---the
vertical locations of the two sets of points in Figure
\ref{fig:prvoting2016} would change per the estimates in Table
\ref{tab:reg}; however, the \emph{differences} between the points
would not.  As we care about differences only, as will be clear
shortly, we can without loss of generality consider in our probability
figure any demographic profile; we have chosen a 50-year old black
male.
...
One potential concern is that, by selecting against younger voters, we
are biasing our estimates of the effect of lines on future turnout.
To this end, studies of the willingness of individuals to leave
hospital emergency rooms without being seen find that being
young is a risk factor for this behavior \citep{sunetal:lwbs,clareycooke:emergencyroomleave}.
...
Restricting attention to 2016 voters only, we now consider a logistic
regression that analyzes whether these individuals voted early in
2016---or, in contrast, voted in another fashion.  Regression results
are in the right column of Table \ref{tab:reg}, and Figure
