...
\begin{abstract}
  ...
  said election and thus the extent to which all the election's voters
  are treated equally.  Voting lines can foster unequal treatment if
  some voters must wait in line longer than others and if waiting in
  line decreases future electoral participation.  We use voter
  ...
  influence the cost of voting and hence the whether voters in an
