...
\begin{abstract}
  ...
  longer than others before casting their ballots.  Voting line
  research is hampered by the fact that little is known about who
  waits in line to vote, and here we argue that early, in-person voter
  check-in times from Florida---942,166 check-ins from the 2012
  General Election and 1,687,217 from 2016---allow us identify
  individuals who waited in line to vote.  We highlight
  disproportionately long wait times incurred by minority voters in
  2012 and show that Florida early in-person voters who waited
  excessively in 2012 had a slightly lower probability---approximately
  one percent---of turning out to vote in the 2016 General Election,
  \emph{ceteris paribus}.  These individuals also had slightly lower
  turnout probabilities in the 2014 Midterm Election, \emph{ceteris
...
cost of voting will vary across voter groups.  This will threaten the
...
later, little is known about who waits in line to vote.  This, we
would argue, is the major impediment in voting line research.  Here we
turn to a relatively untapped source of electoral information, namely,
...
Still, in the interests of transparency, we emphasize that our
check-in times do not themselves specify voter wait times, and as
described shortly we offer a set of assumptions under which check-in
times can be used to study voting lines.  Our use of early voting
...
results to estimate voter wait times at the polls. First, surveys draw
on voter self-reports.  There are a variety of reasons that
