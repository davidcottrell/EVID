...
mn1 <- glm(voted_16 ~ factor(county) + hr + over + hr:over +  gender + race + agegroup + party + logincome + voted_08, data = vte, family = "binomial")
mn2 <- glm(voted_early_16 ~ factor(county) + hr + over + hr:over +  gender + race + agegroup + party + logincome + voted_08, data = vte, family = "binomial")
mn3 <- glm(voted_absentee_16 ~ factor(county) + hr + over + hr:over +  gender + race + agegroup + party + logincome + voted_08, data = vte, family = "binomial")
mn4 <- glm(voted_14 ~ factor(county) + hr + over + hr:over +  gender + race + agegroup + party + logincome + voted_08, data = vte, family = "binomial")
